/**
 * @module interaction
 * This is a main javascript file that contains the scripts of change coordinates of map, play the menu and active layer with opacity

 * @version 1.0.0
 * @see {@link https://code.jquery.com/jquery-1.9.1.min.js|JQuery}
 * @author Diego Torres <diegotorres50@gmail.com>
 * 
 * @TODO We should use react or angular instead of jquery, yes i know it-
 */

$(document).ready(function () {
// variables with differents coordinates zones
  ...
  // change the layer of satelital to road
  ...
  // change coordinates of Bogotá to 4.6588766,-74.0948595 with zoom of 16
  ...
  // change coordinates of point 4.6864072,-74.0531262
